...
#define HEADER_BEGIN "BEGIN"
#define HEADER_ROLE "ROLE"
#define HEADER_CHATNICK "CHATNICK"
#define HEADER_PLAYERGAMESTATE "PLAYERGAMESTATE"
#define HEADER_MSGSERVER "MSGSERVER"
...
static std::string aStrRoles[] = { "ASESINO", "POLICIA", "VICTIMA" };
