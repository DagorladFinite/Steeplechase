...
{
	os << sa.sa_in.sin_addr.S_un.S_un_b.s_b1 << "." << sa.sa_in.sin_addr.S_un.S_un_b.s_b2 << "." << sa.sa_in.sin_addr.S_un.S_un_b.s_b3 << "." <<
		sa.sa_in.sin_addr.S_un.S_un_b.s_b4 << ":" << sa.sa_in.sin_port;
	return os;
}
